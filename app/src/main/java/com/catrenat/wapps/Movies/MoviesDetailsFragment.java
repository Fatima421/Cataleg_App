...
public class MoviesDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_audiovisuals_details, container, false);
        ...
        CardView onBack = view.findViewById(R.id.onBackAudiovisual);
    ...
    private void addDocuOnFirebase() {
        // Create a new user with a first and last name
